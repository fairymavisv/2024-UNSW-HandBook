import { startWorkers } from './snippets/wasm-bindgen-rayon-e6698bae2cc7187f/src/workerHelpers.js';
...
export class HandbookDataInterface {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(HandbookDataInterface.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    static new(data_src_path) {
        const ptr0 = passStringToWasm0(data_src_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.handbookdatainterface_new(ptr0, len0);
    ...
    */
    get_course_info(code) {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.handbookdatainterface_get_course_info(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    ...
    */
    get_program_info(code) {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.handbookdatainterface_get_program_info(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {JsProgramInfo | undefined}
    */
    get_program_and_spec_info(code, spec) {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(spec) ? 0 : passArrayJsValueToWasm0(spec, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.handbookdatainterface_get_program_and_spec_info(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    ...
    */
    list_program_all_coursecodes(program_code) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(program_code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.handbookdatainterface_list_program_all_coursecodes(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v2;
            if (r0 !== 0) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_startWorkers_8a96a2064fdae25c = function(arg0, arg1, arg2) {
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('loader_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
